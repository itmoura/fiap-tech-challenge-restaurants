package com.fiap.itmoura.tech_challenge_restaurant.model.request;
...
public record RestaurantRequest(
    ...
    @NotNull(message = "Nome é obrigatório", groups = OnCreate.class)
    String name,
    ...
    @NotNull(message = "Tipo de cozinha é obrigatório", groups = OnCreate.class)
    String kitchenType,
    
    @Schema(title = "Endereço", description = "Endereço do restaurante", example = "Rua das Flores, 123")
    @NotNull(message = "Endereço é obrigatório", groups = OnCreate.class)
    String address,
    ...
    @NotNull(message = "Horários de funcionamento são obrigatórios", groups = OnCreate.class)
    ...
    @NotNull(message = "ID do dono é obrigatório", groups = OnCreate.class)
    String ownerId,
